...
import static io.github.crustack.slf4j.callerinfo.AddCallerInfoToLogsVisitor.INJECTED_METHOD_PATTERN;
import static io.github.crustack.slf4j.callerinfo.AddCallerInfoToLogsVisitor.SLF4J_LOGGER_FQN;
...
public class Slf4jCallerInfoMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException {
      ...
      log.info(String.format(
          "Make sure to add the MDC parameter '%s' to your logging pattern, otherwise they wont be printed in your logs",
          injectionMdcParameter));
      try {
        new CallerInfoLogsClassWriter(target, filters, injectionMdcParameter, injection,
            includePackageName, injectedMethods, new MavenLogger(log)).execute();
      } catch (IOException e) {
